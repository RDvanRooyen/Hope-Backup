...
namespace WebUI.Data
{
    ...
    {
        // Define additional DBSets here, such as ViewModels that are not mapped 
        //public virtual DbSet<AuthorContentRow> AuthorContentRows { get; set; }
        ...
        partial void OnModelCreatingPartial(ModelBuilder modelBuilder)
        {
            ...
            //RegisterTablelessModel<AuthorContentRow>(modelBuilder, nameof(AuthorContentRow));
        }
